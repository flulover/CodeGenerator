...
def dataElementInstances1 = new DataElementInstancesBuilder()
        .withBooleanDataElementInstance(booleanDataElementInstance)
        .withDecimalDataElementInstance(decimalDataElementInstance)
        .withIntegerDataElementInstance(integerDataElementInstance)
        .withTextDataElementInstance(textDataElementInstance)
        .withSingleSelectDataElementInstance(singleSelectDataElementInstance)
...
def items = new ItemsBuilder()
        .withOrderableSentenceItem(orderableSentenceItem)
        .withOrderableSentenceItem(orderableSentenceItem)
...
def topLevelItems = new TopLevelItemsBuilder()
        .withOrderSetSectionItem(orderSetSectionItem)
